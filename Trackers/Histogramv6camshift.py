...
for idx, image_file in enumerate(image_files[1:]):
    ...
    # CAMShift tracking
    ret, roi = cv2.CamShift(dst, tuple(map(int, roi)), term_criteria)
    ...
    isLost = 1 if width*height == 0 else 0

    # Print tracking info
    print(f"{idx},{xmin},{ymin},{width},{height},{isLost}")
