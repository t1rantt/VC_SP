...
bbox_initial = (173,312,96,58)  # replace these numbers with your initial bounding box

# Initialize the OpenCV's MedianFlow tracker
tracker = cv2.legacy.TrackerMedianFlow_create()

# Get the path to the video frames (images)
images_path = '/home/t1rant/Downloads/Aquarium1/img/*.jpg'  # update the path as needed
